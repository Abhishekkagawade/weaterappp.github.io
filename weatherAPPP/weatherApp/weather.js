...
function weatherReport(data) {
    ...
    fetch(urlcast).then((res) => {
        ...
        document.getElementById('hd').innerText = "humidity" + " " + Math.floor(data.main.humidity) + ' %';
        document.getElementById('pr').innerText = "pressure" + " " + Math.floor(data.main.pressure) + ' mbar';
        document.getElementById('sp').innerText = "wind_speed" + " " + Math.floor(data.main.wind.speed) + ' km/h';
